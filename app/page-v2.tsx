...
const sourceSans = Source_Sans_3({ subsets: ["latin"], weight: ["400", "600"], variable: "--font-source" });
...
export default function HomeV2() {
  ...
  return (
    <div className={`${styles.landing} ${playfair.variable} ${sourceSans.variable}`}>
      <Navbar user={null} />
          ...
          {[
            {
              ...
              popover: "Our sensors detect sudden changes in acceleration and orientation. When a fall is confirmed, an alert fires in under 3 seconds — with impact severity so caregivers know exactly how to respond.",
            },
            {
              id: "vitals",
              color: "sage",
              ...
              popover: "SmartFall continuously logs heart rate and blood pressure in the background. Trends are visualized on the dashboard and unusual readings trigger proactive notifications before a crisis occurs.",
            },
            {
              id: "alerts",
              color: "blue",
              ...
              popover: "Designated caregivers receive instant push and SMS notifications the moment an event is detected. They can acknowledge alerts, view the patient's location, and access recent vitals — all from their phone.",
            },
          ].map((f) => (
            <div key={f.id} className={`${styles.featureCard} ${styles[`card_${f.color}`]} ${openCards.has(f.id) ? styles.cardExpanded : ""}`}>
              ...
              <div className={styles.cardExtra} aria-hidden={!openCards.has(f.id)}>
